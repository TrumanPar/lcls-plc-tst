...
#
#         Project: lcls-plc-tst.tsproj
#        PLC name: lcls_plc_tst (lcls_plc_tst Instance)
...
epicsEnvSet("LOCATION", "PLC:lcls_plc_tst" )
...
epicsEnvSet("ADS_MAX_PARAMS",   "1121")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:lcls_plc_tst")
dbLoadRecords("save_restoreStatus.db", "P=PLC:lcls_plc_tst:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls_plc_tst,IDX=1,TASK_PORT=350")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:lcls_plc_tst")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:lcls_plc_tst,PROJECT=lcls-plc-tst.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.20.0,PLC_HOST=172.21.148.160")

#   LCLS Vacuum: * -> 2.6.2 (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_tst,DEPENDENCY=LCLS_Vacuum,VERSION=2.6.2,VENDOR=SLAC - LCLS")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_tst,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_tst,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lcls_plc_tst,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("lcls_plc_tst.db", "PORT=$(ASYN_PORT),PREFIX=PLC:lcls_plc_tst:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 121
callbackSetQueueSize(2242)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:lcls_plc_tst:")
